...
public class AdapterListCar extends ArrayAdapter<DtoRootDetailOfCar> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view.setTag(new ViewHolder(txt_battery,btn_config,txt_name,txt_model,txt_description,swt_active,btn_ear_of_good,swt_active_geo));
        } else {
    ...
    class ViewHolder {
        ...
        public ViewHolder(TextView txt_battery, ImageButton btn_config, TextView txt_name, TextView txt_model, TextView txt_description, Switch swt_active,ImageButton btn_ear_of_good,Switch swt_active_geo) {
